...
# This will totally move all secondary files generated by steam apps
# into a directory on its own. Typically savegames for native Linux 
# games. You probably don't want this.
HOME=~/.saves
